        ...
        <div className="h-36 overflow-hidden flex justify-center items-center relative">
          ...
          {editable && (
            <div className="absolute right-0 bottom-0 m-2">
              <input type="file" onChange={updateCover} className="hidden" id="coverInput" /> 
              <label htmlFor="coverInput" className="bg-gray-100 py-1 px-2 flex items-center gap-1 rounded-md shadow-sm shadow-black cursor-pointer">Change cover image
